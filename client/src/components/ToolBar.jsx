      ...
      <div className='toolBar'>
        ...
        <div>
          ...
          <button
            ...
            onClick={() => dispatch(setTool(new Rectangle(canvas, socket, sessionId)))}></button>
          <button
            className={`toolBar__button_circle ${selectedTool instanceof Circle ? 'active' : ''}`}
            onClick={() => dispatch(setTool(new Circle(canvas, socket, sessionId)))}></button>
          <button
            className={`toolBar__button_eraser ${selectedTool instanceof Eraser ? 'active' : ''}`}
            onClick={() => dispatch(setTool(new Eraser(canvas, socket, sessionId)))}></button>
          <button
